...
for st in $stlist ; do
     ...
     cd $HERE
        ...
        ${DIR_SPS35}/submitcommand.sh -m $machine -M 1500 -q $serialq_m -j ${var}_hc_${st}_anom -l ${HERE}/logs/ -d ${HERE} -s compute_anomalies_C3S_auto_02Cineca_199502Zeus.sh -i "$input" 
