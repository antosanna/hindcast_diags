...
#BSUB -P 0490
#BSUB -M 1000
#BSUB -e logs/prec_%J.err
#BSUB -o logs/prec_%J.out
...
export var=PRECT
export comp=atm
realm=cam   # define with case
st=07 #define
export do_timeseries=0
export do_atm=1
export do_lnd=0
export do_ice=0
export do_2d_plt=1 #define
dirdiag=/work/csp/as34319/diagnostics/SPS4_hindcasts/07
nmaxens=15
...
case $varmod in
   ...
   TREFMNAV)varobs=T2M;cf=-273.15;units="Celsius deg";obsfile="$dir_obs1/ERA5_1m_clim_1deg_1979-2018_surface.nc";title2="ERA5 $climobs";export maxplot=36;export minplot=-20;delta=4;units_from_here=1;cmp2mod_ncl=$cmp2mod;export cmp2obs_ncl=$cmp2obs;;
