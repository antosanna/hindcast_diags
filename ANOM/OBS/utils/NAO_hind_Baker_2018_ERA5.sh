...
DIRDATA=$SCRATCHDIR/NAO_Baker_2018_obs
mkdir -p $DIRDATA
...
set -evx
     ...
     cdo fldmean -sellonlatbox,-90.,60.,20.,55. $datamm/anom/mslp_${yy}${st}_ano.${refperiod}.nc $DIRDATA/mslp_${yy}${st}_ano.${refperiod}.A1.nc
     cdo fldmean -sellonlatbox,-90.,60.,20.,55. $datamm/anom/mslp_${yy}${SS}_ano.${refperiod}.nc $DIRDATA/mslp_${yy}${SS}_ano.${refperiod}.A1.nc

     cdo fldmean -sellonlatbox,-90.,60.,55.,90. $datamm/anom/mslp_${yy}${st}_ano.${refperiod}.nc $DIRDATA/mslp_${yy}${st}_ano.${refperiod}.A2.nc
     cdo fldmean -sellonlatbox,-90.,60.,55.,90. $datamm/anom/mslp_${yy}${SS}_ano.${refperiod}.nc $DIRDATA/mslp_${yy}${SS}_ano.${refperiod}.A2.nc
